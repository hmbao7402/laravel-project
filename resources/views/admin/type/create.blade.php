    ...
    <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Tạo Thêm Type Mới</h3>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Tạo Thêm Type Mới</h4>
                        {{-- ERROR MESSAGE --}}
                        ...
                        @endif
                        <form class="forms-sample" action="{{url('admin/insert-type')}}" method="get">@csrf
                            <div class="form-group">
                                <label for="title">Tiêu đề</label>
                                <input type="text" name="title" class="form-control"
                                    placeholder="Áo thun, quần dài,...">
                            </div>
